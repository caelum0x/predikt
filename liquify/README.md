# Liquify
Automated market-making bot for prediction markets.
Create limit orders via the Oracle API to provide liquidity, and potentially make a profit!
...
2. Locate your Oracle API Key. You can find it in Your profile => Edit => Api key.
