...
// Accept the DISCORD_* names used in .env.example as aliases for the internal
// TOKEN / CLIENT_ID variables the rest of this file relies on.
if (!process.env.TOKEN && process.env.DISCORD_BOT_TOKEN) {
	process.env.TOKEN = process.env.DISCORD_BOT_TOKEN;
}
