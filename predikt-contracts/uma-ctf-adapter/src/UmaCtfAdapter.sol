...
/// @title UmaCtfAdapter
/// @notice Predikt settlement layer. Enables trustless resolution of Predikt CTF prediction
///         markets via UMA's Optimistic Oracle. Part of Predikt's on-chain layer (MIT).
