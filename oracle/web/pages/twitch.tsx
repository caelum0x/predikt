  ...
  return (
    <Page trackPageView={'twitch landing page'}>
      ...
      <Col className="text-ink-600 bg-canvas-0 max-w-3xl gap-8 rounded p-4 shadow-md sm:mx-auto sm:p-10">
        <TwitchPlaysOracle user={user} privateUser={privateUser} />
        <TwitchChatCommands />
...
function TwitchPlaysOracle(props: {
  user?: User | null
  privateUser?: PrivateUser | null
}) {
    ...
    <div>
      <Row className="mb-4">
        <img
          ...
          alt=""
        />
        <Title className={'!-my-0 md:block'}>Twitch plays Predikt</Title>
      </Row>
      ...
      <Col className="gap-4">
        ...
        <div>
          Similar to Twitch channel point predictions, Predikt allows you to
          create a play-money prediction markets on any question you like and
          feature it in your stream.
        </div>
        <div>
          The key difference is that Predikt's questions function more like a
    ...
    <>
      ...
      <Col className="gap-4">
        <img
          ...
          alt='screenshot of a stream with a game on the right and Predikt console on the right above chat. The console says "Resolve market", the market name, YES NO N/A buttons, a resolve button, and an unfeature market button.'
        />
        ...
        {twitchLinked && privateUser ? (
          <div className="flex flex-col gap-6 sm:flex-row">
            ...
            >
              ...
              by typing in your Twitch chat: <b>/mod OracleBot</b>
              <br />
        ...
        {user && (
          <Col className="mb-8 p-4">
            ...
            <CopyLinkRow
              url={'https://oracle.markets/twitch?referrer=' + user?.username}
