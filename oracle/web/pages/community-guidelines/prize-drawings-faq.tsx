  ...
  return (
    ...
    >
      <SEO
        ...
        description="Frequently asked questions about Predikt Prize Drawings."
      />
      <Col className="mx-auto w-full max-w-5xl px-4 py-8">
        ...
        <p className="text-ink-600 mt-3 text-lg">
          Predikt runs periodic prize drawings where you can win real money
        ...
        <div className="border-ink-200 bg-canvas-0 mt-6 rounded-xl border-2 p-6">
          ...
          <ul className="text-ink-700 mt-3 list-disc space-y-2 pl-5">
            ...
            <li>Cannot be a Predikt employee or immediate family member</li>
          </ul>
        </div>
        ...
        <div className="border-ink-200 bg-canvas-0 mt-6 rounded-xl border-2 p-6">
          ...
          <p className="text-ink-700 mt-3">
            ...
            If no address is provided within the claim period, Predikt may
        ...
        <div className="border-ink-200 bg-canvas-0 mt-6 rounded-xl border-2 p-6">
          ...
          <p className="text-ink-700 mt-3 font-medium">
            Predikt will never ask for your private key, seed phrase, or
            recovery phrase. Anyone asking for these is not Predikt.
          </p>
          <p className="text-ink-700 mt-3">
            Predikt has not issued any cryptocurrency token — any promotion of
            such is fraudulent.
          </p>
        </div>
