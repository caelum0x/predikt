  ...
  return (
    ...
    >
      <SEO
        ...
        description="How Predikt leagues work, how scoring is calculated, and rules around prize eligibility."
      />
      <Col className="mx-auto w-full max-w-5xl px-4 py-8">
        ...
        <p className="text-ink-600 mt-3 text-lg">
          Leagues are Predikt's monthly competitive ladder. You're sorted into
