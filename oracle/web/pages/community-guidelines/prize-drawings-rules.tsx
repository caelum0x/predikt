  ...
  return (
    ...
    >
      <SEO
        ...
        description="Official rules for Predikt Prize Drawings."
      />
      <Col className="mx-auto w-full max-w-5xl px-4 py-8">
        ...
        <p className="text-ink-600 mt-3 text-lg">
          ...
          <Link href="/prize" className="text-primary-500 underline">
            Predikt Prize Drawings
          </Link>
          , operated by Predikt, Inc.
        </p>
        ...
        <div className="border-ink-200 bg-canvas-0 mt-6 rounded-xl border-2 p-6">
          ...
          <p className="text-ink-700 mt-3">
            Predikt, Inc., 425 Divisadero St, San Francisco, CA 94117.
          </p>
        </div>
        ...
        <div className="border-ink-200 bg-canvas-0 mt-6 rounded-xl border-2 p-6">
          ...
          <ul className="text-ink-700 mt-2 list-disc space-y-2 pl-5">
            ...
            <li>Have a valid Predikt account in good standing</li>
            <li>
            ...
            <li>
              Not be an employee or family member of Predikt, or previously
        ...
        <div className="border-ink-200 bg-canvas-0 mt-6 rounded-xl border-2 p-6">
          ...
          <ul className="text-ink-700 mt-2 list-disc space-y-2 pl-5">
            ...
            <li>Any violation of Predikt's Terms of Service</li>
          </ul>
        </div>
        ...
        <div className="border-ink-200 bg-canvas-0 mt-6 rounded-xl border-2 p-6">
          ...
          <p className="text-ink-700 mt-3">
            Predikt's liability is limited to the prize value or $100,
