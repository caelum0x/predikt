  ...
  return (
    <Page trackPageView="moderation guidelines page" className="!col-span-7">
      <SEO
        ...
        description="How Predikt mods are expected to act, decide, and escalate."
      />
      <Col className="mx-auto w-full max-w-5xl px-4 py-8">
        ...
        <p className="text-ink-600 mt-3 text-lg">
          How Predikt mods are expected to act, decide, and escalate. Published
        ...
        <div className="border-ink-200 bg-canvas-0 mt-6 rounded-xl border-2 p-6">
          ...
          <ul className="text-ink-700 mt-3 list-disc space-y-2 pl-5">
            ...
            <li>
              Stay active on Predikt and check #mod-help in Discord regularly.
            </li>
          ...
          <ul className="text-ink-700 mt-2 list-disc space-y-2 pl-5">
            ...
            <li>
              Being consistently negative toward Predikt, staff, or users — we
        ...
        <div className="border-ink-200 bg-canvas-0 mt-6 rounded-xl border-2 p-6">
          ...
          <ul className="text-ink-700 mt-2 list-disc space-y-2 pl-5">
            <li>
              Markets by Tomek, NathanYoung, Gigacasting, the Predikt
              account, and Predikt staff can be resolved as soon as criteria
              are met.
            </li>
