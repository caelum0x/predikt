  ...
  return (
    ...
    >
      <SEO
        ...
        description="Tips for running great markets on Predikt: clear criteria, fair close dates, and clean resolution."
      />
      <Col className="mx-auto w-full max-w-5xl px-4 py-8">
        ...
        <div className="border-ink-200 bg-canvas-0 mt-6 rounded-xl border-2 p-6">
          ...
          <p className="text-ink-700 mt-3">
            Predikt has six question types. Pick the one that fits your
