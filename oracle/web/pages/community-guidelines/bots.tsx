  ...
  return (
    ...
    >
      <SEO
        ...
        description="Rules for running bot accounts on Predikt: how to mark an account as a bot, what changes, and what's expected."
      />
      <Col className="mx-auto w-full max-w-5xl px-4 py-8">
        ...
        <p className="text-ink-600 mt-3 text-lg">
          Automated accounts are welcome on Predikt — they help keep markets
