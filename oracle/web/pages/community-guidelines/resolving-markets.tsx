  ...
  return (
    ...
    >
      <SEO
        ...
        description="Guidelines for resolving markets correctly and promptly on Predikt."
      />
      <Col className="mx-auto w-full max-w-5xl px-4 py-8">
        ...
        <div className="border-ink-200 bg-canvas-0 mt-6 rounded-xl border-2 p-6">
          ...
          <ul className="text-ink-700 mt-2 list-disc space-y-2 pl-5">
            <li>
              Predikt or Mods may resolve your market if unambiguous criteria
            ...
            <li>
              Predikt reserves the right to re-resolve any market resolved
