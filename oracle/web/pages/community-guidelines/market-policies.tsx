      ...
      <Col className="mx-auto w-full max-w-5xl px-4 py-8">
        ...
        <div className="border-ink-200 bg-canvas-0 mt-6 rounded-xl border-2 p-6">
          ...
          <ul className="text-ink-700 mt-2 list-disc space-y-2 pl-5">
            ...
            <li>
              Markets designed to harvest or redistribute Predikt bonuses
            </li>
            <li>
            ...
            <li>
              Markets designed to exploit the Predikt codebase or abuse bugs
            </li>
            <li>
        ...
        <div className="border-ink-200 bg-canvas-0 mt-6 rounded-xl border-2 p-6">
          ...
          <ul className="text-ink-700 mt-2 list-disc space-y-2 pl-5">
            ...
            <li>
              Predikt can't force a creator to resolve a market if they leave
