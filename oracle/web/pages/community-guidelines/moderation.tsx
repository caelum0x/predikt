    ...
    >
      ...
      <Col className="mx-auto w-full max-w-5xl px-4 py-8">
        ...
        <p className="text-ink-600 mt-3 text-lg">
          Predikt Mods are community members who help keep markets accurate,
        ...
        <div className="border-ink-200 bg-canvas-50 mt-4 rounded-xl border-2 p-5">
          <p className="text-ink-700 text-sm">
            ...
            Predikt handles guideline violations — they're not a permanent mark
        ...
        <div className="border-ink-200 bg-canvas-0 mt-6 rounded-xl border-2 p-6">
          ...
          <p className="text-ink-700 mt-3">
            Mods are active Predikt users selected by the community manager.
        ...
        <div className="border-ink-200 bg-canvas-0 mt-6 rounded-xl border-2 p-6">
          ...
          <p className="text-ink-700 mt-3">
            ...
            <a
              className="text-primary-500 underline"
              href="https://oracle.markets/shankypanky"
              target="_blank"
              rel="noreferrer"
            >
              @shankypanky
