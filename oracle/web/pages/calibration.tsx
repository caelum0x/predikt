  ...
  return (
    <Page trackPageView={'platform calibration page'}>
      <SEO
        ...
        description="Predikt's overall track record"
      />
      ...
      <Col className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-ink-600 max-w-2xl text-lg leading-relaxed">
            Explore how Predikt's predictions compare to real-world outcomes.
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            ...
            <CaseStudyCard
              ...
              contract={sbfMarket}
              description="Predikt had a market stable between 5-10% that SBF would be convicted of a felony 1-month before there was any news about it. It then immediately reacted correctly to rumors before any official statements were made."
            />
