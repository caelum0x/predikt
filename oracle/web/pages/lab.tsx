    ...
    <Page trackPageView="lab page" className="px-2">
      ...
      <div className="flex justify-between">
        ...
        <div className="bg-primary-100 text-ink-700 mb-2 flex items-center self-start overflow-hidden rounded-lg">
          ...
          <LabLink href="https://github.com/oracle/manifold">
            Github
          </LabLink>
          <LabLink href="/api">API</LabLink>
          <LabLink href="https://oracle.notion.site/About-4a1e35b5cedf43998161609eea887679">
            More
          </LabLink>
        </div>
      </div>
      ...
      <LabSection>
        <LabCard
          ...
          href="https://salemcenter.oracle.markets/"
          target="_blank"
        />
        <LabCard
          title="✏ Posts"
