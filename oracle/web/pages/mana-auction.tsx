...
const bids = [
  ...
  },
  {
    ...
    displayName: 'Catnee',
    avatar:
      'https://firebasestorage.googleapis.com/v0/b/oracle.appspot.com/o/user-images%2FCatnee%2FeS8aCMJKmK.jpg?alt=media&token=9f3edeac-2e51-478f-8acd-fe8b57973942',
  },
  {
  ...
  },
  {
    ...
    avatar:
      'https://firebasestorage.googleapis.com/v0/b/oracle.appspot.com/o/user-images%2FAlexanderPutilin%2FTt4GFR47qE.jpg?alt=media&token=5e7621c6-8efd-4c66-aefc-d35e6e490ade',
  ...
  },
  {
    ...
    amount: 300,
    avatar:
      'https://firebasestorage.googleapis.com/v0/b/oracle.appspot.com/o/user-images%2FTrong%2FKAhZUwrNdm.jpg?alt=media&token=edfcd113-ddd5-4c7b-92fa-7febb5419c1d',
    displayName: 'Trong',
    username: '8',
  },
  {
  ...
  {
    avatar:
      'https://firebasestorage.googleapis.com/v0/b/oracle.appspot.com/o/user-images%2Fomnishambles%2FDyoVed-RBw.jpg?alt=media&token=c3fbcfbc-62bc-4d8e-8896-445e00b4b6ac',
  ...
  },
  {
    ...
    avatar:
      'https://firebasestorage.googleapis.com/v0/b/oracle.appspot.com/o/user-images%2FConflux%2FIaFDTz3rB-.png?alt=media&token=d064eaf3-f07d-4e16-9cdd-373b64a5cd17',
    displayName: 'Conflux',
    amount: 175,
  },
  {
  ...
  return (
    <Page trackPageView={'mana auction'}>
      <Col className="gap-4 px-4 sm:px-8 sm:pb-4">
        <SEO
          title="Mana auction"
          description="To celebrate April 1st and to give back to the community, Predikt is
        ...
        <div>
          To celebrate April 1st and to give back to the community, Predikt is
