...
export default function DiscordBot() {
  return (
    <Page trackPageView={'discord bot page'}>
      <SEO
        title={'Predikt Discord Bot'}
        description={'Add the Predikt Discord Bot to your server!'}
      />
      <Col className={'w-full items-center '}>
        <Col className={'bg-canvas-0 gap-3 p-4'}>
          ...
          <span className={'mx-4'}>
            The Predikt Discord Bot allows you to trade, search, and create
          ...
          <Row className={'w-full justify-center'}>
            <img
              ...
              alt={`Discord chat message from Predikt Bot containing an embedded link to a prediction market, then four unlabeled buttons, and finally six discord reactions to ${TRADE_TERM} 5 yes, 10 yes, 25 yes, or ${TRADE_TERM} 5 no, 10 no, 25 no.`}
            />
          </Row>
