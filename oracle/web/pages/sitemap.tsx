...
export default function SitemapPage() {
  ...
  return (
    <Page trackPageView={'sitemap page'}>
      <SEO
        title="Sitemap"
        description={`Predikt is a social prediction game. ${capitalize(
          TRADE_TERM
      ...
      <Col className="mx-auto w-full max-w-4xl px-4 pb-12 pt-4">
          ...
          <Row className="items-center gap-3">
            ...
            <div>
              ...
              <p className="text-ink-500 mt-0.5 text-sm">
                Navigate to any part of Predikt
              </p>
            </div>
          </Row>
        </div>
        ...
        <SitemapSection
          ...
          subtitle="Learn how Predikt works"
          className="mb-8"
        >
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            <SitemapLink
            ...
            <SitemapLink
              ...
              href="https://docs.oracle.markets/api"
              external
              icon={CodeIcon}
            />
            <SitemapLink
