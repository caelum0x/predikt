  ...
  return (
    <Col className="w-full max-w-xl gap-6">
      ...
      <Col className="items-center gap-2 text-center">
        ...
        <h1 className="inline-block bg-gradient-to-r from-primary-600 via-fuchsia-500 to-pink-500 bg-clip-text text-4xl font-black tracking-tight text-transparent [-webkit-background-clip:text]">
          Predictle
        </h1>
            ...
            {[1, 2, 3, 4].map((i) => (
              <div
                ...
                className={clsx(
                  ...
                  i <= attemptNumber
                    ? 'bg-gradient-to-br from-primary-500 to-fuchsia-500 shadow-md shadow-primary-200 dark:shadow-primary-500/50'
      ...
      {!gameState.completed ? (
        <button
          ...
          className={clsx(
            ...
            attemptNumber >= 4
              ? 'cursor-not-allowed bg-ink-400 dark:bg-slate-600'
              : 'bg-gradient-to-r from-primary-600 via-fuchsia-500 to-pink-500 shadow-fuchsia-200 hover:scale-[1.02] hover:shadow-xl hover:shadow-fuchsia-200 active:scale-[0.98] dark:shadow-fuchsia-500/30 dark:hover:shadow-fuchsia-500/40'
          )}
        >
                ...
                <div
                  className={clsx(
                    ...
                    isCorrect
                      ...
                      : 'bg-gradient-to-r from-primary-400 to-fuchsia-400 dark:from-primary-500 dark:to-fuchsia-500'
                  )}
...
function ShareButton(props: {
  ...
  const generateShareText = () => {
    ...
    const url = `https://oracle.markets/predictle${
  ...
  return (
    <Page trackPageView="predictle" hideFooter className="!bg-transparent">
      <SEO
        ...
        url="/predictle"
        image="https://oracle.markets/predictle-logo.png"
      />
      ...
      >
        ...
        <div
          className={clsx(
            'pointer-events-none inset-0 -z-10 bg-gradient-to-br from-primary-100 via-fuchsia-50 to-amber-50 dark:hidden',
            bgPositionClass
          )}
        />
        <div
          className={clsx(
            'pointer-events-none inset-0 -z-10 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary-200/30 via-transparent to-transparent dark:hidden',
            bgPositionClass
          )}
        />
        ...
        <div
          className={clsx(
            'pointer-events-none inset-0 -z-10 hidden bg-gradient-to-br from-primary-900/30 via-slate-900 to-fuchsia-900/20 dark:block',
            bgPositionClass
          )}
        />
        <div
          className={clsx(
            'pointer-events-none inset-0 -z-10 hidden bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary-800/20 via-transparent to-transparent dark:block',
            bgPositionClass
          )}
        />
