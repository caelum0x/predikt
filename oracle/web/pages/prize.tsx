  ...
  if (data === undefined) {
    ...
    return (
      <Page trackPageView={'prize-drawing'}>
        <SEO
          title="Predikt Prize Drawing"
          description="Win real USDC in Predikt's prize drawing. No purchase necessary."
          url="/prize"
      ...
      <SEO
        title={
          sweepstakes.sweepstakesNum
            ? `Predikt Prize Drawing #${sweepstakes.sweepstakesNum}`
            : 'Predikt Prize Drawing'
        }
        description={`Win $${totalPrizePool.toLocaleString()} in USDC in Predikt's prize drawing. No purchase necessary.`}
      ...
      <Col className="mx-auto w-full max-w-3xl gap-8 px-4 py-8 sm:px-6">
        ...
        {!isClosed && (
          <p className="text-ink-500 text-center text-sm">
            Read our{' '}
            <a
              href="https://docs.oracle.markets/prize-faq"
              target="_blank"
            ...
            . By participating, you agree to Predikt's{' '}
            <a
              href="https://docs.oracle.markets/prize-rules"
              target="_blank"
              rel="noopener noreferrer"
              className="text-primary-600 hover:underline dark:text-primary-400"
            >
      ...
      <Col className="items-center gap-6">
        ...
        <Col className="w-full max-w-lg gap-3">
          {winners.map((winner) => (
            <Row
              key={winner.ticketId}
              className="items-center gap-2 rounded-xl border border-amber-200 bg-white/80 p-3 dark:border-amber-700 dark:bg-ink-900/50 sm:gap-4 sm:p-4"
            >
