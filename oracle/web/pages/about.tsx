...
import { AboutOracle } from 'web/components/about-oracle'
...
export default function AboutPage() {
  return (
    <Page trackPageView={'about page'} className="!col-span-7">
      <SEO
        title="About"
        description={`Predikt is a prediction market platform. Users place ${TRADE_TERM}s on an upcoming event which creates a probability of how likely it will happen. ${capitalize(
          TRADE_TERM
      ...
      <Col className="mx-auto w-full max-w-3xl p-4">
        ...
        <OracleLogo className="mb-4 flex sm:hidden" />
        <Col className="gap-4">
          <div>
            <AboutOracle className="text-lg" />
          </div>

          <ExplainerPanel className={'max-w-full'} showWhatIsOracle={false} />
          ...
          <div>
            ...
            <div className="mt-4 grid gap-x-2 md:grid-cols-3">
              <LabCard
                title="FAQ"
                href="https://docs.oracle.markets/faq"
                target="_blank"
