...
export default function Charity(props: {
  ...
  return (
    <Page trackPageView={'charity'}>
      <SEO
        title="Predikt for Charity"
        description="Donate your prediction market earnings to charity on Predikt."
        url="/old-charity"
      />
      <Col className="w-full rounded px-4 py-6 sm:px-8 xl:w-[125%]">
        <Col className="">
          <Title>Predikt for Charity</Title>
        ...
        <div className="prose text-ink-500 mt-10 max-w-none">
          ...
          <ul>
            <li>Predikt is not affiliated with any of the above charities.</li>
            <li>
              Unfortunately, your contributions will not be tax deductible.
            </li>
            <li>Donations are wired once each quarter.</li>
            <li>
              Predikt reserves the right to cancel its charity program at any
              time.
            </li>
          </ul>
        </div>
