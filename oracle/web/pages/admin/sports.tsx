...
export default function SportsAdminPage() {
  ...
  async function suggestTags() {
    setSuggesting(true)
    try {
      // Reuse Oracle's topic suggester (embedding similarity) on a
  ...
  const sampleDesc = [
    ...
    sampleDashboardHref
      ...
      : '',
    `Created and managed by [@OracleSports](https://${ENV_CONFIG.domain}/OracleSports)`,
  ]
        ...
        <div className="border-ink-200 bg-ink-50 text-ink-600 mb-6 rounded-lg border p-4 text-sm">
          ...
          <ul className="ml-4 list-disc space-y-1">
            <li>
              ...
              lookahead), owned by <strong>@OracleSports</strong>. Use this
          ...
          <Col className="gap-5">
            ...
            <Col className="gap-1.5">
              ...
              <input
                ...
                placeholder="oracle.markets/dashboard/ms-official-wc2026"
