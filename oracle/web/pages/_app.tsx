...
import { OnboardingRoot } from 'web/components/onboarding/onboarding-root'
...
type OraclePageProps = { auth?: AuthUser }

function MyApp({ Component, pageProps }: AppProps<OraclePageProps>) {
  ...
  const title = 'Predikt'
  const description = `Predikt is a social prediction game. ${capitalize(
    TRADE_TERM
    ...
    <>
      <Head>
        ...
        <meta
          ...
          key="description2"
        />
        <meta property="og:url" content="https://oracle.markets" key="url" />
        ...
        <meta
          name="twitter:image"
          content="https://oracle.markets/logo.png"
          key="image2"
        />
        <meta
          property="og:image"
          content="https://oracle.markets/logo-cover.png"
          key="image1"
        />
        <meta
          name="viewport"
        ...
        <link
          ...
          href="https://oracle.markets/opensearch.xml"
          title="Predikt"
        />
      </Head>
      <style>
      ...
      {devToolsOpen ? (
        ...
        >
          You cannot use developer tools with Predikt. Please close them and
          refresh.
        </div>
      ) : (
        <ThemeProvider>
      ...
      {/* Umami, for pageview analytics on https://analytics.umami.is/share/ARwUIC9GWLNyowjq/Oracle%20Markets */}
      <Script
