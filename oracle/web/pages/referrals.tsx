  ...
  return (
    <Page trackPageView={'referrals'} className="p-3">
      <SEO
        ...
        description={`Invite new users to Predikt and earn up to ${formatMoney(
          REFERRAL_AMOUNT
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary-500 via-purple-500 to-pink-500 p-6 text-white shadow-lg sm:p-8">
          ...
          <div className="relative">
            ...
            <p className="mb-6 max-w-md text-white/90">
              Invite friends to join Predikt and earn{' '}
        ...
        <div className="bg-canvas-0 border-ink-200 dark:border-ink-300 rounded-xl border p-5 shadow-sm sm:p-6">
          ...
          <div className="space-y-4">
            ...
            <HowItWorksStep
              ...
              description="Your friend creates a Predikt account using your link."
            />
            <HowItWorksStep
              number={3}
