...
import { LeaderboardCalibrationCell } from 'web/components/leaderboard-calibration-cell'
...
export default function Leaderboards() {
      ...
      },
      {
        header: (
          <span className="flex items-center justify-end gap-1">
            Calibration
            <InfoTooltip text="How closely this trader's probabilities match reality across resolved trades (0-100). Higher is more accurate." />
          </span>
        ),
        renderCell: (c) => <LeaderboardCalibrationCell userId={c.userId} />,
      },
    ],
  ...
  return (
    <Page trackPageView={'leaderboards'}>
      <SEO
        title="Leaderboards"
        description={`Predikt's leaderboards show the top ${BETTORS}, question creators, and referrers.`}
        url="/leaderboards"
      />
      ...
      <Col className="mx-auto w-full max-w-2xl gap-6 px-4 pb-8 pt-4">
        ...
        <Col className="gap-1">
          ...
          <p className="text-ink-500 text-sm">
            All-time top traders on Predikt
          </p>
        </Col>
