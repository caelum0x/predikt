...
import { BinaryEmbedWidget } from 'web/components/contract/binary-embed-widget'
...
export default function ContractEmbedPage(props: {
  ...
  // Clean, dark, Predikt-branded binary widget: question + big YES/NO price +
  // mini chart + deep link. IRL/QR mode keeps the legacy scan-to-trade view.
  const useBinaryWidget = contract.outcomeType === 'BINARY' && !showQRCode
