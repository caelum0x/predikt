...
const GUIDELINES = [
  ...
  "Report bugs in #bugs on Discord. Report security issues or exploits privately to info@oracle.markets — don't act on them first.",
...
const SECTIONS = [
  ...
  },
  {
    ...
    description: 'FAQs for Predikt Prize Drawings',
    icon: GiftIcon,
  ...
  return (
    <Page trackPageView="community guidelines page" className="!col-span-7">
      <SEO
        ...
        description="Predikt community guidelines to keep the market fair and fun."
      />
      <Col className="mx-auto w-full max-w-5xl px-4 py-8">
        ...
        <p className="text-ink-600 mt-3 text-lg">
          Predikt keeps moderation minimal and trusts you to act in good faith.
