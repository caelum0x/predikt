...
export const PREDICTIVE_CONTRACT_TYPES = {
  BINARY: {
    ...
    value: 'BINARY',
    name: 'yes/no',
    descriptor: 'One question that resolves YES or NO.',
    example: 'Will it rain in the city on New Year’s Eve?',
    visual: (
  ...
  DEPENDENT_MULTIPLE_CHOICE: {
    ...
    descriptor: 'Several options where exactly one wins.',
    example: 'Which team will win the league this season?',
    visual: (
      <Col className="text-primary-400 relative my-auto h-12 w-12">
  ...
  INDEPENDENT_MULTIPLE_CHOICE: {
    ...
    name: 'set',
    descriptor: 'Several options that each resolve YES or NO on their own.',
    example: 'Which of these milestones will ship this year?',
    visual: (
      <Col className="text-primary-400 relative my-auto h-12 w-12">
  ...
  MULTI_NUMERIC: {
    ...
    value: 'MULTI_NUMERIC',
    name: 'numeric',
    descriptor: 'Predict a number within a range you set.',
    example: 'How many people will attend the conference?',
    visual: (
      <Col className="text-primary-400 relative my-auto h-12 w-12">
  ...
  DATE: {
    ...
    value: 'DATE',
    name: 'date',
    descriptor: 'Predict when something will happen.',
    example: 'When will the next product launch happen?',
    visual: (
      <Col className="text-primary-400 relative my-auto h-12 w-12">
...
export const NON_PREDICTIVE_CONTRACT_TYPES = {
  POLL: {
    ...
    value: 'POLL',
    name: 'poll',
    descriptor: 'A vote, not a bet — one vote per person, no trading.',
