...
export const GUIDELINES_SEARCH_INDEX: SearchEntry[] = [
  ...
  },
  {
    ...
    text: 'punishment alts friends accounts collusion unique trader bonus funneling mana referral signup bonuses daily streaks fake identities deceive manipulate market resolution coordinate trades prices odds leaderboard exploiting Predikt bugs laws terms of service',
  ...
  {
    page: 'Resolving Markets',
    section: 'When Predikt can override you',
    text: 'Predikt mods override unresponsive ambiguous disputed traders cede decision position fraudulent re-resolve n/a ambiguity',
  ...
  // Prize Drawings Rules
  {
    ...
    section: 'Eligibility',
    text: 'eligible 18 years old age majority valid Predikt account good standing restricted territory us states canadian provinces countries employee family banned',
  ...
  },
  {
    ...
    text: 'active Predikt users community manager moderator open-minded fair discord mod-help mods site tag status removed reinstated inactivity conduct become candidate apply join new mods selected how to become a mod',
