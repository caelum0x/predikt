...
export const ShareBetCard = (props: ShareBetCardProps) => {
  ...
  return (
    <div className="w-full min-w-full max-w-xl overflow-hidden rounded-lg bg-gradient-to-br from-primary-700 via-primary-600 to-primary-400">
      <div className="flex items-center justify-center pb-4 pt-5">
        <div className="flex items-center gap-2">
          <LogoIcon className="-mt-2 h-14 w-14 text-white" />
          <span className="text-3xl text-white">Predikt</span>
        </div>
      </div>
      ...
      <div className="mx-6 mb-3 rounded-lg bg-white p-6">
        <div className={clsx(' flex', answer ? 'mb-4' : 'mb-6')}>
          <div className="flex-1">
            <h2 className="text-2xl font-bold text-ink-800">{questionText}</h2>
          </div>
        </div>

        <Col className="gap-2">
          {answer && (
            <div className="mb-2 line-clamp-2 w-full text-lg font-semibold text-ink-800">
              {answer}
            </div>
          )}
            ...
            <Row className="items-center gap-2">
              ...
              {bettor.avatarUrl ? (
                <img
                  ...
                  className="h-8 w-8 flex-shrink-0 rounded-full bg-ink-200 object-cover"
                  data-testid="share-avatar"
                />
              ) : (
                <div className="h-8 w-8 flex-shrink-0 rounded-full bg-ink-200"></div>
              )}
              <div className="whitespace-nowrap text-lg text-ink-800">
                {bettor.name}
              </div>
            </Row>
            <div className="whitespace-nowrap text-lg text-ink-500">
