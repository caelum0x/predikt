      ...
      <Combobox value={selectedCountry} onChange={setSelectedCountry}>
        ...
        {selectedCountry !== '' && (
          <button onClick={() => setSelectedCountry('')}>
            <XIcon className="absolute right-3 top-3 h-5 w-5 text-ink-400" />
          </button>
        )}
        <Combobox.Options className="bg-canvas-0 border-ink-300  absolute mt-1 max-h-60 w-full overflow-auto rounded-md py-1 shadow-lg ring-1 ring-opacity-5 focus:outline-none  dark:ring-ink-700 md:text-sm">
