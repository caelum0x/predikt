...
export function buttonClass(size: SizeType, color: ColorType) {
  return clsx(
    ...
    color === 'violet' && [solid, 'bg-primary-500 hover:bg-primary-700'],
    ...
    color === 'gold' && [
      gradient,
      'enabled:!bg-gradient-to-br from-yellow-400 via-yellow-100 to-yellow-300 dark:from-yellow-600 dark:via-yellow-200 dark:to-yellow-400 !text-ink-900',
    ],
