                ...
                <div className="mt-1 w-full rounded-md border border-green-200 bg-white p-2">
                  {isMulti ? (
                    <table className="text-ink-700 w-full text-xs">
                      <thead>
                        <tr className="border-ink-200 text-ink-500 border-b text-left">
...
function CreatorMetricRow(props: { metric: ContractMetric }) {
  ...
  return (
    <Row className="text-ink-700 flex-wrap items-center gap-3 text-xs">
      <Col>
      ...
      {hasShares && (
        <Col>
          <span className="text-ink-500">Shares</span>
          <span>
