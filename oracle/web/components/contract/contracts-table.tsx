  ...
  return (
    <Col className=" w-full sm:mb-2">
      <Link
        ...
        className={clsx(
          'border-ink-200 flex w-full flex-col border-b px-3 py-3.5 text-base outline-none transition-colors last:border-none sm:rounded-xl sm:border sm:px-4 sm:py-4',
          highlighted
            ? 'bg-primary-100 sm:border-primary-300'
            : 'sm:bg-canvas-0 hover:bg-canvas-50 focus-visible:bg-canvas-50 active:bg-canvas-50 sm:hover:border-primary-300'
        )}
      >
    ...
    <div className="border-ink-200 flex w-full animate-pulse border-b p-2 last:border-none sm:rounded-md sm:border-none">
      <div className="flex w-full flex-col justify-between gap-1 sm:flex-row sm:gap-4">
        <Row className={clsx('sm:w-[calc(100%-12rem] w-full gap-2 sm:gap-4')}>
          <div className="bg-ink-300 h-6 w-6 rounded-full" />
          <div className="bg-ink-300 h-5 grow rounded-full" />
        </Row>
        <div className="self-end sm:self-start">
          <div className="bg-ink-300 h-5 w-[175px] rounded-full" />
        </div>
      </div>
    </div>
  )
