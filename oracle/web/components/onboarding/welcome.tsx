  ...
  return (
    <>
      ...
      <div className="mb-4 text-lg">
        Predikt is a play money prediction market platform where you can win
        real cash prizes.
      </div>
      <div className="mb-4 text-lg">
...
function TopicsPage(props: {
  ...
  const closeDialog = async () => {
    ...
    if (
      ...
      await followUser('vuI5upWB8yU00rP7yxj95J2zd952') // follow @OraclePolitics
    }
    ...
    if (
      ...
      await followUser('8lZo8X5lewh4hnCoreI7iSc0GxK2') // follow @OracleAI
    }
