  ...
  return (
    <>
      ...
      {resolveOption === 'CANCEL' && (
        <div className="text-warning">{`Cancel all trades and return coins back to ${BETTORS}. You repay earned fees.`}</div>
      )}
    </>
  )
}
    ...
    <Col className="gap-3">
      ...
      {!contract.shouldAnswersSumToOne ? (
        ...
        <>
          ...
          <div className="bg-canvas-0 border-ink-200 sticky -bottom-[58px] z-10 border-t pt-3 lg:bottom-0">
