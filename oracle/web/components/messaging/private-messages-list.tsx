    ...
    >
      <Row className="items-center gap-3">
        ...
        <div className="relative flex-shrink-0">
          ...
          />
          {isUnseen && (
            <div className="bg-primary-500 animate-in zoom-in absolute -right-0.5 -top-0.5 h-3 w-3 rounded-full ring-2 ring-white duration-200 dark:ring-ink-900" />
          )}
        </div>
      ...
      {channels.length === 0 ? (
        <Col className="items-center justify-center py-16">
          ...
          <p className="text-ink-500 mb-4 text-center text-sm">
            Start a conversation with someone on Predikt
          </p>
        </Col>
      ) : (
