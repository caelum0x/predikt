...
function CoreBadge() {
  return (
    <Tooltip text="I work on Predikt!" placement="right">
      <Foldy
...
// Show a star for Oracle Supporters with tier-appropriate color
...
function SupporterBadge({
  ...
  return (
    <Tooltip text={`Predikt ${tierConfig.name}`} placement="right">
