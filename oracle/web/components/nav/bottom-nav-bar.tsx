...
const itemClass =
  'text-ink-400 block w-full py-1.5 px-3 text-center sm:hover:text-primary-600 transition-colors'
const selectedItemClass = 'text-primary-600'
...
export function BottomNavBar() {
  ...
  return (
    <nav
      ...
      className="border-ink-200 text-ink-400 bg-canvas-0 fixed inset-x-0 bottom-0 z-50 flex select-none items-center justify-between border-t text-xs lg:hidden"
    >
      <ul
        role="list"
      ...
      >
        <Col className="relative mx-auto h-full w-full items-center">
          <div
            className={clsx(
              'rounded-full',
              isOnUserProfile && 'ring-2 ring-primary-600'
            )}
          >
            <Avatar
              size="sm"
