...
export function PivotBanner(props: { hideBanner: () => void }) {
  ...
  return (
    <Banner
      ...
      link="https://news.oracle.markets/p/exploring-cash-prizes-for-good-predictions"
...
export function StateOfTheUnion2026Banner() {
  ...
  return (
    <Banner
      ...
      link="https://oracle.markets/tv/109"
      target="_self"
      setShowBanner={hideBanner}
    >
...
export const FeeBanner = () => {
  ...
  return (
    <Banner
      ...
      link="https://oracle.notion.site/Fee-change-18b54492ea7a80a6b069d488fc3613ee"
      setShowBanner={hideBanner}
    >
      <Row className="items-center gap-2">
        <LogoIcon
...
export const TwombaBanner = () => {
  ...
  return (
    <Banner
      className="bg-primary-100 hover:bg-primary-200  dark:text-primary-800 text-primary-700 hover:text-primary-900 items-center py-2 transition-colors"
      link="https://news.oracle.markets/p/cash-prizes-are-here"
      setShowBanner={hideBanner}
    >
      <Row className=" items-center gap-2">
        <LogoIcon
...
export const ManaForeverBanner = () => {
  ...
  return (
    <Banner
      className="bg-primary-100 hover:bg-primary-200  dark:text-primary-800 text-primary-700 hover:text-primary-900 items-center py-2 transition-colors"
      link="https://oracle.notion.site/Mana-forever-19154492ea7a80c08410ea8c64fac67e?pvs=74"
      setShowBanner={hideBanner}
    >
      <div>
...
export const CyberMondayBanner = () => {
  ...
  return (
    <Banner
      className="items-center bg-gradient-to-r from-blue-950 via-primary-900 to-primary-950 py-3 transition-colors"
      link="/add-funds"
      target="_self"
      setShowBanner={hideBanner}
    >
