...
const TxnBalanceChangeRow = (props: {
  ...
  const reasonToBgClassNameMap: Partial<{
    ...
    CREATE_CONTRACT_ANTE: 'bg-primary-400',
    ...
    CONSUME_SPICE: 'bg-primary-400',
    CONSUME_SPICE_DONE: 'bg-primary-400',
    CONVERT_CASH: 'bg-primary-400',
    CONVERT_CASH_DONE: 'bg-primary-400',
    ...
    LEAGUE_PRIZE: 'bg-primary-400',
    BOUNTY_POSTED: 'bg-primary-400',
