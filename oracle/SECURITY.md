...
Please report security issues by emailing **info@oracle.markets** with the
...
please utilize our dev instance at https://dev.oracle.markets/ instead of
...
- The Oracle web app at https://oracle.markets/
- The Oracle production API at https://api.oracle.markets/

Out of scope:

- Issues solely present on the dev instance
- Reports that require physical access to a user's device
- Social engineering of Oracle staff or users
