...
export const NOTIFICATION_DESCRIPTIONS: notification_descriptions = {
  ...
  onboarding_flow: {
    simple: 'Emails to help you get started using Oracle',
    detailed: 'Emails to help you learn how to use Oracle',
  },
  ...
  airdrop: {
    ...
    detailed: 'Oracle has sent you a gift of mana',
  },
  manifest_airdrop: {
    simple: 'You received a gift for attending Manifest',
    detailed: 'Oracle has sent you a gift for attending Manifest',
  },
  extra_purchased_mana: {
    simple: 'You just received 9x your purchased mana in 2024',
    detailed: 'Oracle has sent you a gift of 9x your purchased mana in 2024.',
  },
  payment_status: {
  ...
  admin: {
    ...
    detailed: 'Notifications from the Oracle team',
  },
