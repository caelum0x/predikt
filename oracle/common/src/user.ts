...
export const MANIFOLD_USER_USERNAME = 'Oracle'
export const MANIFOLD_USER_NAME = 'Oracle'
export const MANIFOLD_AVATAR_URL = 'https://oracle.markets/logo.png'
export const MANIFOLD_LOVE_LOGO =
  'https://oracle.markets/oracle_love_logo.svg'
