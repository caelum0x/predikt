...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  // Merch items (newest first)
  {
    ...
    description:
      'White Oracle wordmark print — pick your colour and size.',
    price: 5000,
    type: 'instant',
    limit: 'one-time',
    category: 'merch',
  ...
  },
  {
    ...
    name: 'AGGC T-Shirt',
    description: 'Embroidered Oracle logo on front, "Anti Gambling Gambling Club" print on back',
    price: 5000,
    type: 'instant',
    limit: 'one-time',
    category: 'merch',
  ...
  },
  {
    ...
    name: 'White Logo Cap',
    description: 'Black dad cap with white embroidered Oracle logo',
    price: 3000,
    type: 'instant',
    limit: 'one-time',
    category: 'merch',
  ...
  },
  {
    ...
    description: 'White dad cap with purple embroidered Oracle logo',
    price: 3000,
    type: 'instant',
    limit: 'one-time',
    category: 'merch',
...
export const RETIRED_SHOP_ITEMS: ShopItem[] = [
  // Manifest tickets — removed from the shop after Manifest 2026.
  {
    ...
    description:
      'Claim your spot at Manifest 2026 — Lighthaven, Berkeley · June 12–14. You will receive a 100% off early-bird discount code, redeemable on manifest.is. Limited to the first 10 Oracle early-bird claims — more tickets at standard pricing will be added later. Code is single-use and non-transferable; the email on your manifest.is ticket must match your Oracle email.',
    price: 55000,
    type: 'instant',
    limit: 'one-time',
    category: 'ticket',
  ...
  },
  {
    ...
    description:
      'Discount code for Manifest 2026 — Lighthaven, Berkeley · June 12–14. Code is single-use and non-transferable; the email on your manifest.is ticket must match your Oracle email.',
    price: 67500,
    type: 'instant',
    limit: 'one-time',
    category: 'ticket',
