...
export const PROD_CONFIG: EnvConfig = {
  // TODO(deploy): replace with YOUR Firebase/Supabase project (projectId/apiKey/authDomain/storageBucket + supabaseInstanceId/anonKey) — the committed values are upstream placeholders; auth WILL fail until set.
  // See oracle/web/docs/BACKEND-CONFIG.md for exactly which fields to change and where to find them.
  domain: 'oracle.markets',
  ...
  firebaseConfig: {
    ...
    authDomain: 'oracle.firebaseapp.com',
    projectId: 'oracle',
    region: 'us-central1',
    storageBucket: 'oracle.appspot.com',
    privateBucket: 'oracle-private',
    messagingSenderId: '128925704902',
    appId: '1:128925704902:web:f61f86944d8ffa2a642dc7',
    measurementId: 'G-SSFK1Q138D',
  },
  twitchBotEndpoint: 'https://twitch-bot.oracle.markets',
  apiEndpoint: 'api.oracle.markets',
  cloudRunId: 'nggbo3neva',
  cloudRunRegion: 'uc',

  adminIds: [
    'IPTOzEqrpkWmEzh6hwvAyY9PqFb2', // Oracle
    ...
    'HT8eUoGkBufqbNB7RayTEOV94VB2', // wasabipesto
    '799tbR05zWe23KnLg5esZaHmuxi2', // Oracle Mod
    'vuI5upWB8yU00rP7yxj95J2zd952', // Oracle Politics
    '8lZo8X5lewh4hnCoreI7iSc0GxK2', // Oracle AI
    'NnVY8olowYMYQGr346dfmHXBSpx2', // Oracle Sports
