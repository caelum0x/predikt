...
// The market creator is always @OracleSports, hardcoded per env — never the
// admin who triggers creation. Any admin can run the create flow on their side;
// the markets are always owned by @OracleSports.
const MANIFOLD_SPORTS_USER_ID_PROD = 'NnVY8olowYMYQGr346dfmHXBSpx2' // @OracleSports (prod)
const MANIFOLD_SPORTS_USER_ID_DEV = 't3R3HV2QFTRGnJxtxhzdesA4stw1' // @OracleSports / sports@oracle.markets (dev)
...
export function buildDescription(
  ...
  parts.push('Created and managed by [@OracleSports](/OracleSports)')
...
// Lines for the comment @OracleSports posts on a market as it resolves —
