...
Everything you wanted to know about [Oracle](https://oracle.markets) in one place!

## Basics - How does Oracle work?
...
On Oracle, anyone can create their own prediction market about any question they want! We believe prediction markets are not only the best way to forecast difficult questions, but also a fun way to interact with friends, build communities over shared interests, and facilitate the sharing of information.

Oracle is the best prediction markets platform because it offers the widest variety of question topics contributed by a large community. This diversity allows you to leverage your experience across multiple domains to showcase your knowledge and earn more mana from successful trades or unique and engaging questions.
...
Yes! Oracle has consistently proven its validity and efficacy as a leading prediction market platform. Oracle compiles site wide prediction data to determine how well calibrated the site is at predicting events, you can assess Oracle's predictive track record in real time on our [platform calibration page](https://oracle.markets/calibration).
...
Oracle is a social prediction game, which makes it the easiest prediction site to use. New users can instantly sign in with existing Google or Apple accounts and start predicting for free in less than a minute. No purchase is required to join and use Oracle.

Oracle is the best prediction site because it offers the largest variety of questions and topics, contributed by an expansive community. Community made markets means that you can easily find more markets that you actually care about and have more opportunities to leverage your knowledge to win mana!

If a market doesn't exist... [Create a market yourself!](https://oracle.markets/create)

### What is mana (M)?

Mana (M) is the play-money currency used to bet on Oracle. It **cannot be converted to cash**. All users start with M1000 for free.

Mana can be used to create, subsidise, and bet on markets.

In addition, you can [purchase more mana](https://oracle.markets/add-funds).

### How can I earn mana?

Mana can be earned by making correct predictions, successful trades, creating popular markets, completing quests, and referring friends.

- **Trading profits** -
  Buy shares at low prices and sell them (or hold until resolution) at higher prices. The main way to earn mana is by being a skilled predictor.

- **Quests** -
  Quests provide specific incentives to engage with Oracle in different ways.

**Daily quests:**

- **Prediction streaks** - Make at least one prediction per day to maintain your streak. The reward starts at M5 and increases by M5 for each consecutive day, up to a maximum of M25 per day. Your streak can be viewed on your profile page.
- **Share a market** - Share a market with others to earn M5.

**Weekly quests:**

- **Create a market** - Create a market to earn M100.

- **Referrals** -
  Refer new users to Oracle and earn M1000 when they sign up using your referral link.
...
### What types of questions can I use Oracle to answer?
...
Some markets may be unranked, unlisted, cancelled, or have their resolutions overruled if they do not comply with the [Community Guidelines](https://oracle.markets/community-guidelines).
...
- Recommendations - Similar to asking for suggestions from another site but with Oracle users are incentivized to give higher quality answers as they can profit from being helpful.
- Accountability/goals - Betting YES on your own market and allowing people to bet NO to motivate you.

#### News & current events

- [News/Current events](https://oracle.markets/news), [Natural Disasters](https://oracle.markets/browse?topic=natural-disasters)
- [Politics](https://oracle.markets/browse?topic=politics)
- [Sports](https://oracle.markets/browse?topic=sports)
- [Economics](https://oracle.markets/browse?topic=economics), [stocks](https://oracle.markets/browse?topic=stocks), [crypto](https://oracle.markets/browse?topic=crypto)
- [Public figures](https://oracle.markets/browse?topic=celebrities)
- Social issues; e.g. [Legal Outcomes](https://oracle.markets/browse?topic=law), [AI Risk](https://oracle.markets/browse?topic=ai-risk) / [AI Safety](https://oracle.markets/browse?topic=ai-safety)
...
- Effective Altruism topics including artificial intelligence and charities
- Debate topics
...
Oracle supports several market types:

- **Yes/No (Binary)** - Simple questions with Yes or No outcomes.
- **Multiple Choice** - Questions with multiple possible answers. Can be configured so answers sum to 100% or are independent.
- **Numeric** - Predict a number within a range.
- **Polls** - Gather opinions without betting (single choice, multi-select, or ranked choice).
- **Bounty Questions** - Offer mana rewards for the best answers.
...
- **Write an engaging description** -
  Sometimes simple markets are the best. In other cases a structured description including any context or background information can be extremely valuable. You can even add images and other embeds.
- **Add it to a topic** -
  Topics are the primary way users filter for relevant markets. Please be careful to only add it to relevant topics. Try to add it to specific topics instead of really general ones. Also, consider making your own topics and inviting friends/interested communities to them from other sites!
- **Write your opinion** -
...
- **Subsidise your market!** -
  Add mana to the [liquidity pool](#what-is-the-liquidity-pool) or set up some limit orders to increase the potential profit traders can make.

### How do I become a good trader?

A good first step is to have a firm understanding of what various numbers mean and how to track your portfolio.
...
- **React to news** -
  Oracle are dynamic, and ongoing events can drastically affect what the probability should look like. There is a lot of mana to be made by being first to act as new information is made public.
- **Buy low, sell high** -
...
- **Create innovative answers** -
  Certain multiple choice markets provide room for creativity! The answers themselves can often affect the outcome based on how compelling they are. Being the first to bet on an answer generally gives the best odds!
- [**Sort by close date**](https://oracle.markets/browse?s=close-date) -
...
- [**Sort by newest**](https://oracle.markets/browse?s=newest) -
...
- **Follow successful traders** -
  This increases your exposure to winning strategies. Watching how some of the [top traders on Oracle](https://oracle.markets/leaderboards) use their mana can provide a good indication of what works. If you're ever curious how someone made a large profit on a market with a small position, or predicted an event, ask them!
...
Whoever created the market gets to resolve it! Oracle puts trust in its users to resolve their own markets in a timely and accurate manner. We encourage creators to set clear resolution criteria in advance. In exceptional circumstances, our team of moderators will overturn resolutions.
...
- Check out the [resolution section in the community guidelines](https://oracle.markets/community-guidelines/resolving-markets).
...
- When resolving multiple choice markets, you can resolve fully to one answer, or select multiple and the % of the winnings you want to go towards each type of share.
...
- Winners are paid out and loans are deducted.
...
Oracle uses a combination of limit orders and an automated market maker. Trades are first filled against limit orders, then against the AMM.
...
Loans allow you to borrow mana against your existing positions, freeing up capital to make additional trades without waiting for markets to resolve.
...
- Available to Oracle members (Plus, Pro, or Premium subscribers).
...
- Loans are distributed proportionally across your unresolved positions.
- When a market resolves or you sell a position, loan amounts are automatically deducted from your proceeds.
...
You can fully [customise all your notifications](https://oracle.markets/notifications?tab=settings&section=).
...
### How do I delete my Oracle account?

To delete your account, please navigate to your [profile page](https://oracle.markets/profile). Click the 3 dot menu in the top right corner, then go to the Delete account tab.
...
### Does Oracle have a content moderation policy or account rules?

For moderation policies and rules, please see our [Community Guidelines](https://oracle.markets/community-guidelines/moderation).

### How do I report misconduct on Oracle?
...
4. How does it violate the [Community Guidelines](https://oracle.markets/community-guidelines)?
5. Potential causes (if known)
6. Evidence of 1-5, submitted to DavidChee/SirSalty via [Discord](https://discord.com/invite/eHQBNBqXuh) or [email](mailto:info@oracle.markets).

This changes the moderation task from "investigation" to "response" and allows for swift action to be taken.

### Is there an official Oracle API?

Yep, [check it out](/api)!

### How does Oracle maintain the largest range of questions?

Oracle is able to maintain the best range of diverse questions thanks to the collaborative participation of its global user base. People from all walks of life regularly submit new predictions across an incredibly wide spectrum of domains. This grassroots process continually expands the variety unlike limited, top-down frameworks of competitors with fewer options.

### What are the Oracle terms and conditions?

Here you can find the [terms and conditions](/terms) and [privacy policy](/privacy-policy).

### How to resolve a dispute on Oracle?

To resolve a dispute on Oracle, users can report issues to moderators for review. If a resolution decision is in line with our rules, the resolution will stand as-is. For abuse, misresolution, or technical failures, markets may be re-resolved.

### What kinds of predictions can I make on Oracle?

You can make predictions on everything on Oracle - from sports scores, election results, and stock market movements, to reality show winners, celebrity news, product launches, and much more. Creativity and current events help people crowdsource new question topics on essentially any imaginable subject. Anyone can sign up for free and submit a question; your curiosity and knowledge are the only limits.

### How does Oracle ensure fair play?

Oracle believes users should have autonomy over their own markets as much as possible, and tries to keep moderation to a minimum and empower users with tools to control the content that they want to see. Oracle ensures fair play through its [community guidelines](https://oracle.markets/community-guidelines); content moderation; bug abuse detection; auditing user activity; and careful game design.

### Can you play Oracle for free?

Yes, Oracle is a free to play social prediction game. All users start with M1000 and can earn more through trading, quests, and referrals. Users may choose to buy additional mana, although it is not necessary.
