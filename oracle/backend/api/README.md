...
[Dev secrets manager](https://console.cloud.google.com/security/secret-manager?project=dev-oracle)
[Prod secrets manager](https://console.cloud.google.com/security/secret-manager?project=oracle)
