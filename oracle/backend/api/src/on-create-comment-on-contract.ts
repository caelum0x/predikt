...
${answer.text}`
  ...
  } on a prediction market on Oracle (that is managed by a creator) to determine if the creator's latest comment clarifies the resolution criteria.
...
SYSTEM: Please analyze if the creator's latest comment ${
  ...
  Here's info about how resolving a market works in Oracle:
...
export const checkCommentNeedsResponse = async (
  ...
  The creator is a user of Oracle that created the market and resolves it using their judgement, along with the title and description of the market.
