...
<head>
  <title>Unsubscribe from Oracle emails</title>
  <!--[if !mso]><!-->
            ...
            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;"
              ...
              <tr>
                <td style="width:550px;">
                  <a href="https://oracle.markets" target="_blank">
                    <img alt="banner logo" height="auto" src="https://oracle.markets/logo-banner.png"
                  ...
                  style="direction:ltr;font-size:0px;padding:0px 0px 0px 0px;padding-bottom:0px;padding-left:0px;padding-right:0px;padding-top:0px;text-align:center;">
                    ...
                    <a href=${optOutAllUrl}>here</a>
                       to unsubscribe from all emails.
                                        ...
                                        <br/>
                    <span>Click
                    <a href='https://oracle.markets/notifications?tab=settings'>here</a>
