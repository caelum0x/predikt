...
export const getMarketResolutionEmail = (
  ...
  // https://app.mailgun.com/app/sending/domains/mg.oracle.markets/templates/edit/market-resolved-bulk/initial
...
export const sendWelcomeEmail = async (
  ...
  return await sendTemplateEmail(
    ...
    {
      from: 'Stefanie from Oracle <stefanie@oracle.markets>',
...
Thanks for signing up! I'm one of the cofounders of Oracle, and was wondering how you've found your experience on the platform so far?

If you haven't already, I encourage you to try creating your own prediction market (https://oracle.markets/create) and joining our Discord chat (https://discord.com/invite/eHQBNBqXuh).
...
James
Cofounder of Oracle
https://oracle.markets
 `

  await sendTextEmail(
    privateUser.email,
    'How are you finding Oracle?',
    emailBody,
    {
      from: 'James from Oracle <james@oracle.markets>',
...
export const sendUnactivatedNewUserEmail = async (
  ...
  return await sendTemplateEmail(
    privateUser.email,
    `Help improve Oracle + win $100 Amazon gift card`,
    templateId,
    {
      name: firstName,
      unsubscribeUrl,
    ...
    {
      from: 'Ian from Oracle <ian@oracle.markets>',
    }
  )
}
...
export const sendThankYouEmail = async (
  ...
  return await sendTemplateEmail(
    privateUser.email,
    'Thanks for your Oracle purchase',
    'thank-you',
    {
      name: firstName,
      unsubscribeUrl,
...
export const sendNewAnswerEmail = async (
  ...
  const from = `${name} <info@oracle.markets>`
...
export const sendInterestingMarketsEmail = async (
  ...
  await sendTemplateEmail(
    privateUser.email,
    `${contractsToSend[0].question} & 5 more interesting markets on Oracle`,
    'interesting-markets',
    {
      name: firstName,
      unsubscribeUrl,
...
export const sendBonusWithInterestingMarketsEmail = async (
  ...
  await sendTemplateEmail(
    privateUser.email,
    `Interesting questions on Oracle + ${bonusAmount} bonus mana`,
...
export const sendNewPrivateMarketEmail = async (
  ...
  return await sendTemplateEmail(
    ...
    {
      from: `${creatorName} on Oracle <no-reply@oracle.markets>`,
    }
  )
}
