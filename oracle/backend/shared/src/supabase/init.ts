...
export function createSupabaseDirectClient(opts?: {
  ...
  const client = pgp({
    ...
    // See queries to run during outage here: https://www.notion.so/oracle/Backend-resources-8fba2b67cad04dd188564442c5876bfa?pvs=4#a8629a618e9e44ee9b6bbe408b10f9ff
