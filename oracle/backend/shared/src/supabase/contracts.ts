...
export const isContractNonPredictive = async (contract: Contract) => {
  ...
  if (contract.creatorUsername === 'OracleLove') return true
...
One year from now, will the percentage that this question resolves YES (as shown by Oracle) be above 50%?
