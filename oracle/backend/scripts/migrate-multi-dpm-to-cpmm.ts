...
if (require.main === module) {
  runScript(async ({ pg, firestore }) => {
    ...
    // console.log('https://oracle.markets' + contractPath(contractToMigrate))
    ...
    console.log(
      sortedContracts
        .map((c) => 'https://oracle.markets' + contractPath(c))
        .join('\n')
    )
...
const migrateMultiDpmToCpmm = async (
  ...
  console.log('https://oracle.markets' + contractPath(contract))
