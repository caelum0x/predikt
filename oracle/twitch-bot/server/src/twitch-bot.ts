...
const MSG_PREDICT = () => `Predict here for free to win a share of 250USD: https://oracle.markets/post/storybook-brawl-streamer-showdown`;
/* cSpell:disable */
  ...
  constructor(app: App) {
    ...
    const featureCommand: CommandDef = {
      ...
      handler: async (params: CommandParams) => {
        ...
        await stream.selectMarket((await Oracle.getMarketBySlug(args[0])).id);
      },
    };
  ...
  public async joinChannel(channelName: string) {
    ...
    return this.client
      ...
      .then(async () => {
        ...
        let message = 'Hey there! I am the Oracle chat bot.';
