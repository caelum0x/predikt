...
This [monorepo][monorepo] has basically everything involved in running and operating Oracle.
...
Oracle's public API and web app are hosted by [Vercel][vercel]. Our data has been stored in Firebase's database [Cloud Firestore][cloud-firestore] but we have almost entirely migrated it to SQL hosted on [Supabase][supabase].
...
By contributing to this codebase, you are agreeing to the terms of the [Oracle CLA](./.github/CONTRIBUTING.md).
