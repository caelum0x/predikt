Oracle is the world's most popular prediction market website.

Oracle lets you bet on upcoming events using play money. As other users bet against you, it creates a probability of how likely the event will happen—this is known as a prediction market.
...
1. Basics and How It Works:
   ...
   - Oracle uses play-money (mana) instead of real currency.
...
7. Market Mechanics:
   ...
   - Oracle uses a combination of limit orders and automated market maker
